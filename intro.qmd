...
The current project of the `The Flourishing Lab` is to discover predictors of flourishing and resilience in New Zealand Mulsim community by conducting a longitudinal panel study^[In the panel study, data are collected from the sampe participants overtime] in the context of [New Zealand Attitudes and Values Study](https://www.psych.auckland.ac.nz/en/about/new-zealand-attitudes-and-values-study.html) (**NZAVS**).
